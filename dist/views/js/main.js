...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    //Move calculation of dx and newWidth out of for loop
...
var frame = 0;
//moved it out of updatepositions()
...
function updatePositions() {
  ...
  //move document.body.scrolltTop out of for loop
  var top = document.body.scrollTop;
  var widthMove =  (window.innerWidth / 2);
  //move calculation of phase out of loop
  var phaseArray = [];
  for(var i = 0; i < 5; i++) {
    phaseArray[i] = Math.sin((top / 1250) + (i % 5));
  }
